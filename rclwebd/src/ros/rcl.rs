...
impl Attachment {
  ...
  pub fn init(domain_id: usize, node_name: &str) -> Result<Self, RclError> {
    ...
    unsafe {
      ...
      check(b::rcl_init_options_init(&mut init_options, allocator()), "rcl_init_options_init")?;
      let result = (|| {
        check(
        ...
        check(b::rcl_init(0, std::ptr::null(), &init_options, context.as_mut()), "rcl_init")?;
  ...
  pub fn service_names_and_types(&mut self) -> Result<Vec<(String, Vec<String>)>, RclError> {
    names_and_types(self.node.as_ref(), service_names_fn, "rcl_get_service_names_and_types", false)
  }
...
impl SerializedPublisher {
  ...
  pub fn publish(&mut self, payload: &[u8]) -> Result<(), RclError> {
    ...
    unsafe {
      ...
      check(
        b::rcl_publish_serialized_message(self.publisher.as_ref(), &message, std::ptr::null_mut()),
...
impl SerializedClient {
    ...
    F: FnMut() -> Result<(), RclError>,
  {
    ...
    let result = (|| {
      ...
      let mut seq = 0i64;
      unsafe {
        check(b::rcl_send_request(self.client.as_ref(), request, &mut seq), "rcl_send_request")?;
      }
      ...
      loop {
        ...
        if remaining.is_zero() {
          return Err(RclError { ret: RCL_TIMEOUT, message: "service call timed out".to_owned() });
        }
        wait_set.wait_raw_client(self.client.as_ref(), guard, remaining.as_nanos() as i64)?;
        let mut header = b::rmw_request_id_t { writer_guid: [0; 16], sequence_number: 0 };
        let ret = unsafe { b::rcl_take_response(self.client.as_ref(), &mut header, response) };
  ...
  pub fn call(
    ...
    self.call_with_pump(context, guard, request_ts, response_ts, request_cdr, timeout, || Ok(()))
  }
...
impl ActionClient {
    ...
    F: FnMut() -> Result<(), RclError>,
  {
    ...
    let result = (|| {
      ...
      deserialize_into(action_ts.goal, goal_cdr, unsafe { send_goal_req.add(16) as *mut c_void })?;
      ...
      unsafe {
        check(
          b::rcl_action_send_result_request(self.client.as_ref(), get_result_req, &mut result_seq),
          "rcl_action_send_result_request",
        )?;
      }

      self.wait_and_take_result_response(context, guard, get_result_resp, timeout, &mut pump)?;
    ...
    F: FnMut() -> Result<(), RclError>,
  {
    ...
    loop {
      ...
      let mut header = b::rmw_request_id_t { writer_guid: [0; 16], sequence_number: 0 };
      let ret =
        unsafe { b::rcl_action_take_goal_response(self.client.as_ref(), &mut header, response) };
    ...
    F: FnMut() -> Result<(), RclError>,
  {
    ...
    loop {
      ...
      let mut header = b::rmw_request_id_t { writer_guid: [0; 16], sequence_number: 0 };
      let ret =
        unsafe { b::rcl_action_take_result_response(self.client.as_ref(), &mut header, response) };
      if ret == RCL_ACTION_CLIENT_TAKE_FAILED {
        unsafe { b::rcutils_reset_error() };
        continue;
      }
  ...
  fn wait_and_take_cancel_response(
    ...
    loop {
      ...
      let mut header = b::rmw_request_id_t { writer_guid: [0; 16], sequence_number: 0 };
      let ret =
        unsafe { b::rcl_action_take_cancel_response(self.client.as_ref(), &mut header, response) };
      if ret == RCL_ACTION_CLIENT_TAKE_FAILED {
        unsafe { b::rcutils_reset_error() };
        continue;
      }
...
impl ActionServer {
  pub fn create(
    ...
    unsafe {
      ...
      let mut alloc = allocator();
      check(b::rcl_clock_init(b::RCL_STEADY_TIME, clock.as_mut(), &mut alloc), "rcl_clock_init")?;
  ...
  pub fn accept_goal(
    ...
    let send = unsafe { b::rcl_action_send_goal_response(self.server.as_ref(), header, response) };
  ...
  pub fn take_result_request(
    ...
    let mut header = b::rmw_request_id_t { writer_guid: [0; 16], sequence_number: 0 };
    let ret =
      unsafe { b::rcl_action_take_result_request(self.server.as_ref(), &mut header, request) };
    if ret == RCL_ACTION_SERVER_TAKE_FAILED {
      unsafe { b::rcutils_reset_error() };
  ...
  pub fn succeed_goal(&mut self, handle: *mut b::rcl_action_goal_handle_t) -> Result<(), RclError> {
    unsafe {
      ...
      check(b::rcl_action_notify_goal_done(self.server.as_ref()), "rcl_action_notify_goal_done")
    }
  }
  ...
  pub fn publish_feedback(
    ...
    let result = (|| {
      ...
      deserialize_into(action_ts.feedback, feedback_cdr, unsafe { msg.add(16) as *mut c_void })?;
      unsafe {
        check(
  ...
  pub fn take_cancel(
    ...
    let mut header = b::rmw_request_id_t { writer_guid: [0; 16], sequence_number: 0 };
    let ret =
      unsafe { b::rcl_action_take_cancel_request(self.server.as_ref(), &mut header, request) };
    if ret == RCL_ACTION_SERVER_TAKE_FAILED {
      unsafe { b::rcutils_reset_error() };
    ...
    let result = (|| {
      ...
      let mut cancel_response = unsafe { b::rcl_action_get_zero_initialized_cancel_response() };
      let process = unsafe {
      ...
      let send = unsafe {
        b::rcl_action_send_cancel_response(
          self.server.as_ref(),
          &mut header,
          (&mut cancel_response.msg as *mut b::action_msgs__srv__CancelGoal_Response).cast(),
        )
      };
      unsafe {
        let _ = b::rcl_action_cancel_response_fini(&mut cancel_response);
...
impl WaitSet {
  ...
  pub fn wait(
    ...
    assert!(subscriptions.len() <= self.subscription_capacity, "subscription wait set overflow");
    ...
    unsafe {
      ...
      for service in services {
        check(
          b::rcl_wait_set_add_service(self.wait_set.as_mut(), service.raw(), std::ptr::null_mut()),
  ...
  pub fn wait_raw_client(
    ...
    unsafe {
      ...
      if !guard.is_null() {
        check(
          b::rcl_wait_set_add_guard_condition(self.wait_set.as_mut(), guard, std::ptr::null_mut()),
  ...
  pub fn wait_clients(
    ...
    unsafe {
      ...
      for client in clients {
        check(
          b::rcl_wait_set_add_client(self.wait_set.as_mut(), client.raw(), std::ptr::null_mut()),
          "rcl_wait_set_add_client",
        )?;
      }
      self.add_guard(guard)?;
