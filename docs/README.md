...
- Run `bun run check` to run `docs:check` then `protocol-check` (local Markdown links/images/anchors/PCR enrollment, then R2WP v0 registry/CDDL contract validation).
