...
Copy counts, wire expansion, ingest latency / CPU / RSS, and the reproducing baseline versus Foxglove and rosbridge are in [performance](./performance.md). [Validation](./validation.md) owns comparative workloads, metrics, and evidence.
