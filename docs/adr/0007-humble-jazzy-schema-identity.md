...
- Remaining M0-01 work synchronizes this decision into [compatibility](../compatibility.md), [R2WP](../protocol/r2wp.md), [`rclmbt`](../runtime/rclmbt.md), [`rclwebd`](../gateway/rclwebd.md), [validation](../validation.md), and the [implementation plan](../../tasks/plan.md).
