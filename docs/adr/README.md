...
- ADR 0009 freezes wire version 0 under M0-03a. M0-03b contract validation is complete ([`scripts/protocol-check.ts`](../../scripts/protocol-check.ts) and root wiring). M0-03c TypeScript CBOR codec is complete ([`sdk/typescript/src/protocol/cbor.ts`](../../sdk/typescript/src/protocol/cbor.ts)). M0-03d TypeScript bootstrap/extension/control/frame codecs and valid/boundary fixtures are complete ([`sdk/typescript/src/protocol/`](../../sdk/typescript/src/protocol/), [`scripts/protocol-fixtures.ts`](../../scripts/protocol-fixtures.ts), [`protocol/testdata/`](../../protocol/testdata/README.md)). M0-03e malformed, state-sequence, and transport parity fixtures are complete ([fixture README](../../protocol/testdata/README.md)). M0-03f Rust and M0-03g MoonBit reference parsers are complete. M0-03h cross-language agreement is complete ([agreement README](../../protocol/testdata/agreement/README.md)). Implementation follows the accepted ADR 0009 decision. Runtime, edge, support-profile, and licensing decisions continue as their gates require.
