...
M0 foundation work is in progress. R2WP v0 milestone `M0-03a–h` is verified complete: the normative contract, TypeScript codecs, Rust and MoonBit reference parsers, fixture corpora, and cross-language agreement gate are in place.
...
| `rclmbt/` | MoonBit/Wasm runtime module (`moon.work` member; R2WP reference parser under `protocol/`) |
