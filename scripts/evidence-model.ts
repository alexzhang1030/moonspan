/**
 * Shared qualification report v1 model (R4-03 recycle of M0-05a).
 *
 ...
 *
 * Gates are the current R0–R4 / U0 / X0 delivery gates. Raw measurements
 * live under docs/evidence/*.json; this contract wraps them as reports.
 */

import path from "node:path";

export const SCHEMA_VERSION = 1 as const;
export const REPORT_ID = "rclweb-qualification-report-v1" as const;
export const SCHEMA_REL = "docs/evidence/schema/qualification-report-v1.json";
export const VALID_DIR_REL = "docs/evidence/testdata/valid";
