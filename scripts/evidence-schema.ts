...
export function buildQualificationReportSchema(): Record<string, unknown> {
  return {
    ...
    $id: "https://github.com/alexzhang1030/rclweb/docs/evidence/schema/qualification-report-v1.json",
    title: "rclweb qualification report v1",
    description:
      "Closed machine-readable qualification evidence contract for rclweb gates. Generated from scripts/evidence-schema.ts using constants in evidence-model.ts; the Bun checker enforces the same constants plus ordering, calendar, filesystem, and integrity checks.",
    type: "object",
