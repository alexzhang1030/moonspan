...
| `.github/workflows/ci.yml` | Foundation: `setup-bun` + cached just (retrying GitHub fetch on miss) + `rust-toolchain`; e2e images copy Bun from `oven/bun` ([gotchas](./gotchas.md#github-releases-downloads-need-retries)) |
