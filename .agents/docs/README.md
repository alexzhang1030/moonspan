...
| TypeScript package public surface | [`rclweb`](../../docs/typescript.md), [R4-04](../../docs/milestones/r4-04-sdk.md), [ADR 0013](../../docs/adr/0013-typescript-package-rclweb.md) |
...
| TypeScript package public surface | [`rclweb`](../../docs/typescript.md), [R4-04](../../docs/milestones/r4-04-sdk.md) |
...
| `rclwebd/src/config.rs` (`SupportRow`, all six Phase 1 rows) | [ADR 0008](../../docs/adr/0008-one-adapter-row-per-gateway-process.md), [R3-03 H-FT](../../docs/milestones/r3-03-h-ft-webtransport.md), [R4-03 remaining rows](../../docs/milestones/r4-03-support-matrix.md), [gotchas](./gotchas.md#one-gateway-process-binds-one-support-row) |
...
| `docker/compose.r4-03-remaining-rows-e2e.yml` | [R4-03 J-CY/J-ZN/H-CY/H-ZN live lanes](../../docs/milestones/r4-03-support-matrix.md) (CI `e2e-ros-talker-jazzy-rmw` / `e2e-ros-talker-humble-rmw`; one image per distro via `RMW_APT_PACKAGES`, zenoh rows start `rmw_zenohd`) |
...
| `rclwebd/src/acl.rs`, OpenChannel gate in `connection.rs` | [R4-01](../../docs/milestones/r4-01-oidc-sros2-audit.md); default `off` admits everything, `enforce` is default-deny with wire code 12 ([gotchas](./gotchas.md#acls-default-to-off-enforce-is-default-deny)) |
...
| `docker/Dockerfile.rclwebd`, `docker/compose.r4-02-gateway.yml` | Jazzy runtime image (J-FT default; J-CY / J-ZN via `SUPPORT_ROW` / `RMW_APT_PACKAGES` build args) + host-network compose ([deploy](../../docs/deploy.md)) |
| `docker/Dockerfile.rclwebd-h-ft`, `docker/compose.r4-02-gateway-h-ft.yml` | Humble runtime image (H-FT default; H-CY / H-ZN via build args; regenerates FFI) + host-network compose ([deploy](../../docs/deploy.md)) |
| `docker/compose.r4-02-gateway-rmw.yml` | Remaining-row gateway shapes + zenoh router companions (`just gateway-row <row>`) ([deploy](../../docs/deploy.md)) |
...
| `typescript/**` | [`rclweb`](../../docs/typescript.md), [intent](./intent.md), [architecture](../../docs/architecture.md), [ADR 0013](../../docs/adr/0013-typescript-package-rclweb.md), [R1-04 host](../../docs/milestones/r1-04-wasm-host-sdk.md), [R1-05 e2e](../../docs/milestones/r1-05-e2e-evidence.md), [R2-01 publish/reconnect](../../docs/milestones/r2-01-data-plane-hardening.md), [R2-02 buffer strategies + large batch](../../docs/milestones/r2-02-large-message-path.md), [R2-04 perf baseline](../../docs/milestones/r2-04-perf-baseline.md), [R3-01 service/action/graph/parameters](../../docs/milestones/r3-01-services-actions-graph.md), [R3-03 WT ConnectOptions](../../docs/milestones/r3-03-h-ft-webtransport.md#outcome-webtransport), [R4-04 public vs internal](../../docs/milestones/r4-04-sdk.md). Reconnect re-opens service/action with the same channel IDs; Worker `telemetry()` is the last poll snapshot ([gotchas](./gotchas.md#reconnect-is-a-fresh-session-not-sessionresume), [gotchas](./gotchas.md#worker-telemetry-is-the-last-poll-snapshot)) |
| `typescript/src/index.ts`, `internal.ts` | Public rclcpp-shaped `init`/`Node` vs host/ABI/`connect` ([`rclweb`](../../docs/typescript.md#public-vs-internal)); public Node graph getters hide GraphSnapshot JSON ([gotchas](./gotchas.md#public-node-graph-hides-graphsnapshot-json), [gotchas](./gotchas.md#scripted-graphsnapshot-endpoints-must-be-complete-control-maps)) |
| `rclweb/src/types/host_value.rs`, `typescript/src/generated-value.ts` | Packed host layout for Phase 1 corpus msgs and srv/action sections (`CMD_SEND_GENERATED` / `rclweb_decode_generated`; service/action poll cmds convert in the engine) ([gotchas](./gotchas.md#generated-corpus-messages-use-a-packed-host-layout), [R4-04](../../docs/milestones/r4-04-sdk.md)) |
| `typescript/src/worker/` | I/O Worker messages; service/action CDR (or generated host-value bytes) and PointCloud2 `data` are copied and leased in the Worker ([`rclweb`](../../docs/typescript.md#public-vs-internal), [R4-04](../../docs/milestones/r4-04-sdk.md), [gotchas](./gotchas.md#serviceaction-poll-events-carry-payload-views), [gotchas](./gotchas.md#worker-pointcloud2-copies-data-inline-borrows-it)). PointCloud2 header/fields travel on CMD 17 ([gotchas](./gotchas.md#pointcloud2-header-and-fields-travel-on-the-host-command)). Generated corpus messages use CMD 18 and a packed host layout ([gotchas](./gotchas.md#generated-corpus-messages-use-a-packed-host-layout)). Public `Node` hides this. |
| `examples/**` | [`rclweb`](../../docs/typescript.md), [examples README](../../examples/README.md), [R1-05 e2e + demo](../../docs/milestones/r1-05-e2e-evidence.md), [R4-04](../../docs/milestones/r4-04-sdk.md) |
...
| `scripts/build-wasm.ts`, `typescript/wasm/rclweb.wasm` | Fat-LTO wasm ship; `release-wasm` inherits native release ([gotchas](./gotchas.md#release-wasm-inherits-native-release-settings)) |
| I/O Worker URL | Source `.ts` vs bundle `.js` ([gotchas](./gotchas.md#worker-url-follows-the-script-extension)) |
