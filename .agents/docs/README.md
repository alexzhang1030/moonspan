...
| `.github/workflows/ci.yml` | Foundation: `setup-bun` / `setup-just` / `rust-toolchain`; e2e images copy Bun from `oven/bun` ([gotchas](./gotchas.md#github-releases-downloads-need-retries)) |
