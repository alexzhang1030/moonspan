...
| `scripts/rosidl-dts.ts`, `typescript/src/interfaces.generated.ts`, `typescript/generated/rosidl.d.ts` | ROS 2 `.msg`/`.srv`/`.action` → `rcl-web` DTS / classes ([how to](../../docs/typescript.md#generate-types-from-ros-interfaces)); `<=` bounds are not constants ([gotchas](./gotchas.md#ros-interface-bounds-are-not-constant-assignments)) |
