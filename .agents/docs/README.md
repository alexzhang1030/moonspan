...
| `rclweb/src/types/host_value.rs`, `sdk/typescript/src/generated-value.ts` | Packed host layout for Phase 1 corpus msgs (`CMD_SEND_GENERATED` / `rclweb_decode_generated`) ([gotchas](./gotchas.md#generated-corpus-messages-use-a-packed-host-layout), [R4-04](../../docs/milestones/r4-04-sdk.md)) |
| `sdk/typescript/src/worker/` | I/O Worker messages; service/action CDR and PointCloud2 `data` are copied and leased in the Worker ([SDK](../../docs/sdk.md#public-vs-internal), [R4-04](../../docs/milestones/r4-04-sdk.md), [gotchas](./gotchas.md#serviceaction-poll-events-carry-payload-views), [gotchas](./gotchas.md#worker-pointcloud2-copies-data-inline-borrows-it)). PointCloud2 header/fields travel on CMD 17 ([gotchas](./gotchas.md#pointcloud2-header-and-fields-travel-on-the-host-command)). Generated corpus messages use CMD 18 and a packed host layout ([gotchas](./gotchas.md#generated-corpus-messages-use-a-packed-host-layout)). Public `Node` hides this. |
