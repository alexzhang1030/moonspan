...
| `sdk/typescript/src/worker/` | I/O Worker messages; service/action CDR and PointCloud2 `data` are copied and leased in the Worker ([SDK](../../docs/sdk.md#session), [R4-04](../../docs/milestones/r4-04-sdk.md), [gotchas](./gotchas.md#serviceaction-poll-events-carry-payload-views), [gotchas](./gotchas.md#worker-pointcloud2-copies-data-inline-borrows-it)). PointCloud2 publish synthesizes XYZ fields ([gotchas](./gotchas.md#pointcloud2-publish-synthesizes-fields)) |
