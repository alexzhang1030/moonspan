...
| Support matrix vs raw measurements | [Validation](./validation.md#evidence-contract), [evidence README](../../docs/evidence/README.md), [R4-03](../../docs/milestones/r4-03-evidence-harness.md) |
...
| Committed measurements and support-matrix status | [Evidence](../../docs/evidence/README.md), [R4-03](../../docs/milestones/r4-03-evidence-harness.md) |
...
| `docs/evidence/*.json` | Run measurements; promotion is a human matrix edit ([R4-03](../../docs/milestones/r4-03-evidence-harness.md), [gotchas](./gotchas.md#do-not-add-an-evidence-check-ci-job)) |
