...
| `sdk/typescript/src/worker/` | I/O Worker messages; service/action CDR is copied and leased in the Worker ([SDK](../../docs/sdk.md#session), [R4-04](../../docs/milestones/r4-04-sdk.md), [gotchas](./gotchas.md#serviceaction-poll-events-carry-payload-views)) |
