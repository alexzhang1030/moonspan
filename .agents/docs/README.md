...
| `scripts/cargo-publish.ts` | Crate LICENSE/NOTICE copies must match the root ([gotchas](./gotchas.md#crate-licensenotice-copies-are-committed)); fixture crates stay private ([release](../../docs/release.md)) |
...
| `.github/workflows/release.yml` | npm + crates.io OIDC ([release](../../docs/release.md), [ADR 0016](../../docs/adr/0016-oidc-trusted-publish.md)). Do not set `NODE_AUTH_TOKEN` ([gotchas](./gotchas.md#do-not-put-nodeauthtoken-on-the-npm-oidc-job)). First crates.io publish is manual ([gotchas](./gotchas.md#cratesio-oidc-cannot-create-the-first-crate)) |
