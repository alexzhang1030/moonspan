...
| `docker/**` | [R1-05 compose lane](../../docs/milestones/r1-05-e2e-evidence.md), [R2-04 live perf compose](../../docs/milestones/r2-04-perf-baseline.md), [R3-03 H-FT mock + live Humble](../../docs/milestones/r3-03-h-ft-webtransport.md), GitHub fetch retries ([gotchas](./gotchas.md#github-releases-downloads-need-retries)) |
| `.github/workflows/ci.yml`, `scripts/github-release-curl.sh`, `scripts/install-pinned-bun.sh` | Foundation `just` + e2e Bun zips retry GitHub Releases ([gotchas](./gotchas.md#github-releases-downloads-need-retries)) |
