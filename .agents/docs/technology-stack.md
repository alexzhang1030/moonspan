...
| `typescript/` | Bun workspace package `rclweb@0.0.1` (public). Public application contract; `rclweb/internal` is host/ABI/test helpers ([`rclweb`](../../docs/typescript.md), [ADR 0013](../../docs/adr/0013-typescript-package-rclweb.md)) |
