...
| `typescript/` | Bun workspace package `rcl-web@0.0.1` (public). Public application contract; `rcl-web/internal` is host/ABI/test helpers ([`rcl-web`](../../docs/typescript.md), [ADR 0014](../../docs/adr/0014-typescript-package-rcl-web.md)) |
