...
| TypeScript npm bundle | tsdown ([ADR 0015](../../docs/adr/0015-tsdown-ship-bundle.md)) | Owner ruling: do not publish `.ts` source; ship ESM + `.d.ts` |
