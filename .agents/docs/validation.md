...
1. M0 fixes support profiles, toolchains, contract fixtures, the CDR corpus, and report schemas. The foundation CI lane records pinned-toolchain and root-command evidence. M0-03 is complete; its [completion record](../../docs/milestones/m0-03-r2wp-foundation.md) owns delivery revisions and accepted local results, while the [fixture reference](../../protocol/testdata/README.md) and [agreement reference](../../protocol/testdata/agreement/README.md) own reproducible commands and artifacts. M0-02 adds hosted workflow URLs and uploaded evidence. Phase 1 qualification covers H-FT, H-CY, J-FT, and J-CY under the [support matrix](../../docs/support-matrix.md) and [ADR 0008](../../docs/adr/0008-one-adapter-row-per-gateway-process.md). Studio begins at U0 after M3.
