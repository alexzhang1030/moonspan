...
3. R2 proves the hardened data plane: publish, QoS subset, budgets, reconnect ([R2-01](../../docs/milestones/r2-01-data-plane-hardening.md)), adversarial fixtures, fuzzing, and the performance baseline against Foxglove bridge and rosbridge.
