...
- Timing, copies, allocations, memory growth, or toolchain drift reopen runtime-boundary review; the copy budget (two controllable payload copies) is a standing contract. Foxglove / rosbridge comparison: [performance](../../docs/performance.md).
