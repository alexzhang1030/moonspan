...
| R4-04 | Active | SDK stabilization, docs, examples, and release — first slice: public vs internal exports, SDK docs, Worker URL, subscribe-chatter on `dist/`; npm publish / `1.0.0` / D-06 remain follow-ups |
