...
- [~] R4-04 SDK stabilization and release (public vs internal exports, SDK docs, Worker URL, subscribe-chatter on `dist/`, Worker session ops, PointCloud2 sample events; npm publish still open).
