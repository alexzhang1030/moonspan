...
- [ ] R1-01 Port the CDR core to Rust against the frozen contract; pass the committed corpus.
...
- [ ] Live sample flows in CI; demo reviewed; copy budget holds.

## R2: Data-plane hardening

- [ ] R2-01 Publish direction, QoS subset, budgets, reconnect.
- [ ] R2-02 Large-message path on both buffer strategies.
