...
This package stays `"private": true` and `"version": "0.0.0"` until a human release review. Consume it from this repository's Bun workspace (`"@rclweb/sdk": "workspace:*"`). Do not publish it to npm in this slice. Licensed under Apache License 2.0; see the repository [LICENSE](../../LICENSE) and [licensing](../../docs/licensing.md).
